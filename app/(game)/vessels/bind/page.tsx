...
function BindPageInner() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(routes.shrine(slotNum));
    } catch {
  ...
  if (!validSlot) {
    return (
      <div className="mx-auto max-w-md px-4 py-12" data-testid="bind">
...
export default function BindPage() {
  return (
    <Suspense
      fallback={
        <div className="mx-auto max-w-md px-4 py-12 text-zinc-400" data-testid="bind">
          Loading…
        </div>
      }
    >
