...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-12" data-testid="page-login">
      <div>
        ...
        <p className="mt-4 text-center text-sm text-zinc-500">
          ...
          >
            {isRegister ? "SIGN IN" : "BIND ACCOUNT"}
          </button>
        </p>
        <Link
          href="/"
          className="mt-6 inline-block text-sm text-zinc-500 hover:text-zinc-300 min-h-[44px] flex items-center"
        >
